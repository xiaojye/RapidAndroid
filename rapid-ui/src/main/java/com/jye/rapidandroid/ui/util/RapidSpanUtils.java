...
/**
 * 描述：Span构建工具类（Builder模式）
 * 创建人：jye-ixiaojye@163.com
 */
public final class RapidSpanUtils {
     ...
     *             </ul>
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setStrikethrough() {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setUnderline() {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setSuperscript() {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setSubscript() {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                  final Blur style) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                    final float dx,
                                    final float dy,
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RapidSpanUtils} instance
     */
    public RapidSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
