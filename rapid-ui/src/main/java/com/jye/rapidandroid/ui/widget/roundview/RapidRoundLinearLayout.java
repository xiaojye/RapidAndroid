 ...
 * 圆角LinearLayout
 */
public class RapidRoundLinearLayout extends LinearLayout implements RapidRoundAction {

    private RapidRoundHelper mRoundHelper = new RapidRoundHelper();

    public RapidRoundLinearLayout(Context context) {
        this(context, null);
    }

    public RapidRoundLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RapidRoundLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
