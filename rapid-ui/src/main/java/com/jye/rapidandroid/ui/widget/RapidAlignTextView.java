...
/**
 * 描述：两端对齐的text view，可以设置最后一行靠左，靠右，居中对齐
 * <p>
 * 作者：jye-ixiaojye@163.com
 */
public class RapidAlignTextView extends AppCompatTextView {
    ...
    public RapidAlignTextView(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public RapidAlignTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
