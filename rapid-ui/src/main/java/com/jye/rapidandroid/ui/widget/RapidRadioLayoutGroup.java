 ...
 */
public class RapidRadioLayoutGroup extends LinearLayout {
    ...
    public RapidRadioLayoutGroup(Context context) {
        super(context);
        setOrientation(LinearLayout.VERTICAL);
        init();
    }

    public RapidRadioLayoutGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RapidRadioLayoutGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RapidRadioLayoutGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == RapidRadioLayoutGroup.this && child instanceof ViewGroup) {
