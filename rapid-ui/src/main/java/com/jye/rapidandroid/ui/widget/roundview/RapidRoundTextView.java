 ...
 * 圆角TextView
 */
public class RapidRoundTextView extends AppCompatTextView implements RapidRoundAction {

    private RapidRoundHelper mRoundHelper = new RapidRoundHelper();

    public RapidRoundTextView(Context context) {
        this(context, null);
    }

    public RapidRoundTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RapidRoundTextView(Context context, AttributeSet attrs, int defStyleAttr) {
