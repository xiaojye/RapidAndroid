 ...
 * 圆角FrameLayout
 */
public class RapidRoundFrameLayout extends FrameLayout implements RapidRoundAction {

    private RapidRoundHelper mRoundHelper = new RapidRoundHelper();

    public RapidRoundFrameLayout(Context context) {
        this(context, null);
    }

    public RapidRoundFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RapidRoundFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
