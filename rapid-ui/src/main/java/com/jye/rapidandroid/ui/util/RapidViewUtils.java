 ...
 */
public final class RapidViewUtils {

    private RapidViewUtils() {
...
//    }
    ...
    public static void playViewBackgroundAnimation(final View v, @ColorInt int startColor, @ColorInt int endColor, long duration, int repeatCount, int setAnimTagId, final Runnable endAction) {
        ...
        RapidViewUtils.setBackgroundColorKeepPadding(v, startColor);
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                RapidViewUtils.setBackgroundColorKeepPadding(v, (Integer) animation.getAnimatedValue());
            }
        });
        if (setAnimTagId != 0) {
     ...
     * if (RapidViewUtils.getISLastLineSpacingExtraError()) {
