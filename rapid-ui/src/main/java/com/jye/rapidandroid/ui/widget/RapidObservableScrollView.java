 ...
 */
public class RapidObservableScrollView extends ScrollView {

    private int mScrollOffset = 0;

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public RapidObservableScrollView(Context context) {
        super(context);
    }

    public RapidObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RapidObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
        void onScrollChanged(RapidObservableScrollView scrollView, int scrollX, int scrollY, int oldScrollX, int oldScrollY);
    }
