 ...
 * 描述：
 * <p>
 * 方便查找View。用户需要在使用时调用initContentView，
 ...
 * 如果页面中的控件比较多，就会有很多的类型转换,而使用ViewFinder则免去了类型转换, 示例如下 : TextView
 * textView = ViewFinder.findViewById(viewId);
 * </p>
 * 创建人：jye-ixiaojye@163.com
 */
public final class RapidListViewFinder {

    public static String TAG = RapidListViewFinder.class.getSimpleName();
    ...
    public static <T extends View> T findViewById(int viewId) {
        ...
        Log.d(TAG, "### find view = " + targetView);
