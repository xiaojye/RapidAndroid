 ...
 */
public class RapidStatusBarUtils {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(RapidDeviceUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (RapidNotchHelper.isNotchOfficialSupport()) {
            handleDisplayCutoutMode(window);
        }

        // 小米和魅族4.4 以上版本支持沉浸式
        // 小米 Android 6.0 ，开发版 7.7.13 及以后版本设置黑色字体又需要 clear FLAG_TRANSLUCENT_STATUS, 因此还原为官方模式
        if (RapidDeviceUtils.isFlymeLowerThan(8) || (RapidDeviceUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (RapidDeviceUtils.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (RapidDeviceUtils.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return RapidDeviceUtils.isMIUIV5() || RapidDeviceUtils.isMIUIV6() ||
                RapidDeviceUtils.isMIUIV7() || RapidDeviceUtils.isMIUIV8();
    }
    ...
    public static boolean FlymeSetStatusBarLightMode(Window window, boolean light) {
        ...
        if (window != null) {
            ...
            if(RapidDeviceUtils.isFlymeLowerThan(7)){
                try {
            ...
            }else if(RapidDeviceUtils.isFlyme()){
                result = true;
            }
        }
        return result;
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(RapidDeviceUtils.isZUKZ1() || RapidDeviceUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (RapidDeviceUtils.isTablet(context)
                && sStatusBarHeight > RapidScreenUtils.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
