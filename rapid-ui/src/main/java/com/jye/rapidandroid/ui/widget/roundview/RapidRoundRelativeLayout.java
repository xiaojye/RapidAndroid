 ...
 * 圆角RelativeLayout
 */
public class RapidRoundRelativeLayout extends RelativeLayout implements RapidRoundAction {

    private RapidRoundHelper mRoundHelper = new RapidRoundHelper();

    public RapidRoundRelativeLayout(Context context) {
        this(context, null);
    }

    public RapidRoundRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RapidRoundRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
