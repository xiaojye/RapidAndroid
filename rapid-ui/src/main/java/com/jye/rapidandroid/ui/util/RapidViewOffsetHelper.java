 ...
 */
public final class RapidViewOffsetHelper {
    ...
    public RapidViewOffsetHelper(View view) {
        mView = view;
    }
    ...
    /**
     * Set the top and bottom offset for this {@link RapidViewOffsetHelper}'s view.
     *
    ...
    /**
     * Set the left and right offset for this {@link RapidViewOffsetHelper}'s view.
     *
     * @param offset the offset in px.
     * @return true if the offset has changed
     */
